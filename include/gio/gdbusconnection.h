...
GLIB_AVAILABLE_IN_ALL
guint ctsgw_g_dbus_connection_register_object (GDBusConnection                  *connection,
                                               const gchar                *object_path,
                                               GDBusInterfaceInfo         *interface_info,
...
GLIB_AVAILABLE_IN_ALL
gboolean ctsgw_g_dbus_connection_unregister_object (GDBusConnection *connection, guint registration_id);
